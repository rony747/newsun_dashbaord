        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a data-bs-toggle="collapse" href="#themePages"
                   ...
                   aria-controls="themePages" role="button" aria-expanded="false">
                    <i class="material-icons-round opacity-10">dashboard</i>
                    <span class="nav-link-text ms-2 ps-1">ThemePages</span>
                </a>
                <div class="collapse {{ $activePage == 'allThemePages' ? ' show ' : '' }}  " id="themePages">
